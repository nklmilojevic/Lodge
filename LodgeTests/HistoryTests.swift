...
class HistoryTests: XCTestCase {
  ...
  func testAddingItemThatIsSupersededByExisting() {
    ...
    firstItem.application = "Lodge.app"
    ...
    secondItem.application = "Lodge.app"
  ...
  func testAddingItemFromLodge() {
    ...
    let secondContents = [
      ...
      HistoryItemContent(
        type: NSPasteboard.PasteboardType.fromLodge.rawValue,
        value: "".data(using: .utf8)
      )
    ]
    let second = HistoryItem()
    Storage.shared.context.insert(second)
    second.application = "Lodge.app"
