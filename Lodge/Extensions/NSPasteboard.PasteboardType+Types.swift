...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/nklmilojevic/Lodge/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from Lodge.
  static let fromLodge = NSPasteboard.PasteboardType(rawValue: "com.nklmilojevic.Lodge")
