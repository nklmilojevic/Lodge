...
extension Defaults.Keys {
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .lodge)
  ...
  static let popupFontSize = Key<Int>("popupFontSize", default: 13)
  ...
  static let ocrInImages = Key<Bool>("ocrInImages", default: true)
  ...
  static let showTitle = Key<Bool>("showTitle", default: false)
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 540, height: 540))
